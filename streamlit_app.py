...
# Methods data
methods = [
    {"name": "Oral Contraceptive Pill", "image": "http://media.self.com/photos/5e986f441911a00008b4275d/master/pass/birthcontrol_pills.jpg", "perfect": "<1%", "typical": "7%", "typical_failure": 7, "pros": ["Regulates periods", "Reduces acne", "Daily control"], "cons": ["Daily pill", "No STI protection", "Side effects possible"]},
    {"name": "Male Condom", "image": "https://post.healthline.com/wp-content/uploads/2022/02/male-condoms-1296x1000-body-1296x1004.png", "perfect": "2%", "typical": "13%", "typical_failure": 13, "pros": ["STI protection", "No hormones", "Widely available"], "cons": ["User-dependent", "Can break"]},
    ...
    {"name": "Depo-Provera Injection", "image": "https://www.verywellhealth.com/thmb/zML8U8nV3QmdRdO_eC1l1QI5Sqs=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/depo-56a1c4193df78cf7726dc0e9.jpg", "perfect": "<1%", "typical": "4%", "typical_failure": 4, "pros": ["Every 3 months", "No daily routine"], "cons": ["Delayed fertility return", "Bone density concerns"]},
    {"name": "Contraceptive Patch", "image": "https://www.nhsinform.scot/wp-content/uploads/2024/02/contraceptive-patch-1.jpg", "perfect": "<1%", "typical": "7%", "typical_failure": 7, "pros": ["Weekly change", "Regulates periods"], "cons": ["Visible", "Skin irritation possible"]},
    {"name": "Vaginal Ring (NuvaRing)", "image": "https://www.obgynecologistnyc.com/wp-content/uploads/2016/09/Nuvaring-Birth-Control-Vaginal-Ring.jpg", "perfect": "<1%", "typical": "7%", "typical_failure": 7, "pros": ["Monthly", "Low dose hormones"], "cons": ["Insertion required"]},
    {"name": "Female Condom", "image": "https://www.cdc.gov/condom-use/media/images/Femalecondom5hires.png", "perfect": "5%", "typical": "21%", "typical_failure": 21, "pros": ["STI protection", "User control"], "cons": ["Higher failure rate"]},
    {"name": "Diaphragm", "image": "https://ixbapi.healthwise.net/Resource/14.7/en-us/media/medical/hw/aco3583_368x240.jpg", "perfect": "6%", "typical": "17%", "typical_failure": 17, "pros": ["Reusable", "Hormone-free"], "cons": ["Insertion each time", "Spermicide needed"]},
    {"name": "Fertility Awareness", "image": "https://images.squarespace-cdn.com/content/v1/5ce5fdaed49c8900017d5630/1604508343420-GX1XCK067VKE20TZ1FWY/Cycle+13+marked.png", "perfect": "1-9%", "typical": "24%", "typical_failure": 24, "pros": ["No hormones", "Free"], "cons": ["High effort", "Irregular cycles reduce reliability"]},
]
