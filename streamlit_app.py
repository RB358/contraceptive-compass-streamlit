...
st.set_page_config(page_title="Find you contraceptive in seven questions.", layout="centered")
...
methods = [
    ...
    {"name": "Depo-Provera Injection", "image": "https://www.verywellhealth.com/thmb/zML8U8nV3QmdRdO_eC1l1QI5Sqs=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/depo-56a1c4193df78cf7726dc0e9.jpg", "perfect": "<1%", "typical": "4%", "typical_failure": 4.0, "pros": ["Every 3 months", "No daily routine"], "cons": ["Delayed fertility return", "Bone density concerns"]},
    {"name": "Contraceptive Patch", "image": "https://www.nhsinform.scot/wp-content/uploads/2024/02/contraceptive-patch-1.jpg", "perfect": "<1%", "typical": "7%", "typical_failure": 7.0, "pros": ["Weekly change", "Regulates periods"], "cons": ["Visible", "Skin irritation possible"]},
    {"name": "Vaginal Ring (NuvaRing)", "image": "https://www.obgynecologistnyc.com/wp-content/uploads/2016/09/Nuvaring-Birth-Control-Vaginal-Ring.jpg", "perfect": "<1%", "typical": "7%", "typical_failure": 7.0, "pros": ["Monthly", "Low dose hormones"], "cons": ["Insertion required"]},
...
st.title("Find your contraceptive in seven questions.")
